 ...
 */
- (nullable NSArray<NSString *> *)contentsOfDirectoryAtPath:(NSString *)path error:(NSError **)error NS_AVAILABLE(10_5, 2_0);//返回指定目录下的所有文件的文件名
 ...
 */
- (BOOL)fileExistsAtPath:(NSString *)path;//判断一个文件（传入假设的文件路径）是否存在
- (BOOL)fileExistsAtPath:(NSString *)path isDirectory:(nullable BOOL *)isDirectory;//判断一个文件是否文件夹
