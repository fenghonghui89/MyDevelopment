...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch(indexPath.row){
        case 0:
            cell.textLabel.text=@"MainViewController";
            break;
        case 1:
            cell.textLabel.text=@"ViewController2";
            break;
        case 2:
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    switch (indexPath.row) {
        case 0:
            ...
            break;
        case 1:
            [[SliderViewController sharedSliderController] showContentControllerWithModel:@"ViewController2"];
            break;
        default:
            break;
    }
