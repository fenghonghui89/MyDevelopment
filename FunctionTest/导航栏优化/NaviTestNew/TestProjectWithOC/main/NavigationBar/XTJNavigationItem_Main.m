...
-(void)customInitUI{
    ...
    [self.right1Btn setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    [self.right1Btn.titleLabel setFont:[UIFont systemFontOfSize:15]];
    
    [self.right2Btn setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
