...
private func func9(_ fun:(String,String)->(String,String)) {
  let result = fun("A","a");
  print(result);
}
...
//MARK:函数类型作为函数返回值
private func funcBase10_1(_ n:Int) -> Int {
  return n*n;
}

private func funcBase10_2(_ n:Int) -> Int {
  return n*n*n;
}

private func func10(_ b:Bool) -> ((Int)->Int) {
...
//MARK:函数嵌套
private func func11(_ n:Int) -> Int {
  
  func func11_1(_ n:Int)->Int{
    return n*n;
  }
