...
private func func2_1() {
  ...
  let dic4 = ["name":"Hany","age":12] as [String : Any];//[String:NSObject]类型
  var dic44 = [12:"Hany","age":12] as [AnyHashable : Any];//[NSObject:NSObject]类型
  var dic444:NSDictionary = dic4 as NSDictionary;//NSDictionary类型
  var dic4444:NSDictionary = ["name":"Hany","age":12];//NSDictionary类型
  let dic5:NSMutableDictionary = [12:"Hany","age":12];//NSMutableDictionary类型
  print(dic5);
...
private func func2_2() {
  ...
  //删除指定键值，并返回删除之前的值
  let oldValue = person.removeValue(forKey: 10);
  print(oldValue);
  print(person.count);
...
private func func2_3() {
  ...
  let value1:Int? = Int(myDic1["key1"]!);
  print(value1);
  
  var myDic2 = ["key1":"200","key2":30] as [String : Any];
  let value2:String = String(describing: myDic2["key2"]);
  print(value2);
  
  var myDic3 = ["key1":"200","key2":30] as [String : Any];
  let value3:Int = myDic3["key1"] as! Int;
  print(value3);
}
...
private func func2_4() {
  //Dictionary类型字典
  let dic = [13:"冯鸿辉","age":12] as [AnyHashable : Any];
...
private func func2_5() {
  let dic = ["name":"Hany","age":12] as [String : Any];
...
private func func2_6() {
  ...
  let dic = ["1":"one","2":2] as [String : Any];
  var dic1 = dic;
  dic1["1"] = "11";
  print(dic,dic1);
}
