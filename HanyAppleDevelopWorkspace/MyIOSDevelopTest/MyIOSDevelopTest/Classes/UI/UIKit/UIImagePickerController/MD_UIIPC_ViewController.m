...
-(void)viewDidDisappear:(BOOL)animated{
  UIView *editView = [self.view viewWithTag:1001];
  [editView removeFromSuperview];
  
  UIButton *btn = [self.view viewWithTag:1002];
  [btn removeFromSuperview];
  
  UIButton *btn2 = [self.view viewWithTag:1003];
...
-(void)customInitUI
{
  ...
  [editView setTag:1001];
  [editView setBackgroundColor:[UIColor grayColor]];
  [editView setFrameX:10 y:80+10 w:viewW-20 h:viewH-80-10-10-30-10];
  ...
  [btn setTag:1002];
  [btn setFrameX:10 y:y w:100 h:30];
  ...
  [btn2 setTag:1002];
  [btn2 setFrameX:x y:y w:100 h:30];
