...
@implementation PPSecretQuestionsView
...
- (void)commitButtonTouchUpInside
{
    ...
    [ppMBProgressHUD setLabelText:@"正在发送请求..."];
    PPWebViewData *ppWebViewData = [[PPWebViewData alloc] init];
    [ppWebViewData setDelegate:self];
    
    [ppWebViewData getBindQuestion:_question1 Question_2:_question2 Answer_1:_answerTextField1.text Answer_2:_answerTextField2.text NextCode:_nextCode];
    [ppWebViewData release];
}
...
-(void)hiddenSecretQuestionsViewInLeft
{
    [super hiddenViewInLeft];
}


-(void)hiddenSecretQuestionsViewInRight
{
...
{
    [self hiddenSecretQuestionsViewInRight];
...
- (void)dealloc
{
    if (PPDEALLOC_ISNSLOG) {
        NSLog(@"PPSecretQuestionsView dealloc");        
    }
