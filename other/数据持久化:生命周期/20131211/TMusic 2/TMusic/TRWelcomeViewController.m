...
//        myMusicTabBarItem.image = [UIImage imageNamed:@"tabbar_item_my_music.png"];
        ...
        UITabBarItem * myMusicTabBarItem = tabBarItems[0];
        myMusicTabBarItem.image = [[UIImage imageNamed:@"tabbar_item_my_music.png"]  imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        ...
        UITabBarItem * selectedTabBarItem = tabBarItems[1];
        selectedTabBarItem.image = [[UIImage imageNamed:@"tabbar_item_selected.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        ...
        UITabBarItem * storeTabBarItem = tabBarItems[2];
        storeTabBarItem.image = [[UIImage imageNamed:@"tabbar_item_store.png"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        ...
        UITabBarItem * moreTabBarItem = tabBarItems[3];
        moreTabBarItem.image = [[UIImage imageNamed:@"tabbar_item_more.png"]  imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
