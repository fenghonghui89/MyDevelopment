...
//键盘消失时调整坐标 键盘显示时调整坐标
-(void)changeUIFrameWhenKeyboardWillShowOrHidden
{
...
-(void)addObserver
{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(changeUIFrameWhenKeyboardWillShowOrHidden) name:UIKeyboardWillShowNotification object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(changeUIFrameWhenKeyboardWillShowOrHidden) name:UIKeyboardWillHideNotification object:nil];
}
