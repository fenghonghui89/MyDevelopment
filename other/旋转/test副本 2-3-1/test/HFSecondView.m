...
{
    [self setFrame:CGRectMake(0, 0, UIScreen_Width, UIScreen_Height)];
    
    [self.bgView setFrame:CGRectMake(0, 0, UIScreen_Width, UIScreen_Height)];
    ...
    [self.textField setFrame:CGRectMake(self.bgView.bounds.size.width - (self.bgView.bounds.size.width - 100) / 2 - 100, 130, 100, 30)];
}
...
-(void)initHorizontalFrame
{
    ...
    [self.bgView setFrame:CGRectMake(0, 0, UIScreen_Height, UIScreen_Width)];
...
#pragma mark - 键盘弹收时坐标改变 -
//键盘显示时调整坐标
-(void)changeUIFrameWhenKeyboardWillShow
{
    NSLog(@" --- changeUIFrameWhenKeyboardWillShow");
...
//键盘消失时调整坐标
-(void)changeUIFrameWhenKeyboardWillHidden
{
    NSLog(@" --- changeUIFrameWhenKeyboardWillHidden");
...
-(void)showViewInRight
{
    ...
    UIInterfaceOrientation interfaceOrientation = (UIInterfaceOrientation)[[UIApplication sharedApplication] statusBarOrientation];
    if (interfaceOrientation == UIInterfaceOrientationPortrait){
        [self setFrame:CGRectMake(UIScreen_Width, 0, UIScreen_Width, UIScreen_Height)];
    }else if(interfaceOrientation == UIInterfaceOrientationPortraitUpsideDown) {
        [self setFrame:CGRectMake(-UIScreen_Width, 0, UIScreen_Width, UIScreen_Height)];
    }else if(interfaceOrientation == UIInterfaceOrientationLandscapeLeft) {
        [self setFrame:CGRectMake(0, -UIScreen_Height, UIScreen_Width, UIScreen_Height)];
    }else if(interfaceOrientation == UIInterfaceOrientationLandscapeRight) {
        [self setFrame:CGRectMake(0, UIScreen_Height, UIScreen_Width, UIScreen_Height)];
    }
    
    //开始动画，传递参数showViewInRight到下面的选择器中
...
{
    //开始动画，传递参数hiddenViewInRight到下面的选择器中
...
#pragma mark - 旋屏开关、添加旋屏通知和键盘通知 -
-(void)addObserver
{
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(initFrameForOrientation) name:UIApplicationDidChangeStatusBarOrientationNotification  object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(changeUIFrameWhenKeyboardWillShow) name:UIKeyboardWillShowNotification object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(changeUIFrameWhenKeyboardWillHidden) name:UIKeyboardWillHideNotification object:nil];
}
