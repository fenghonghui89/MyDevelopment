...
//  dic = ["xxx":"hello"]
  ...
  let param = dic.objectForKey("xxx") as? String
...
private func kl_nil(str:String?) {
...
private func kl_nilString(paramaDic:NSDictionary?){
  ...
  let v = dic.objectForKey("xxx") as? String
  let v1:String = (dic.objectForKey("xxx") as? String)!
  let v2:String? = dic.objectForKey("xxx") as? String
  let v3:String! = dic.objectForKey("xxx") as? String
...
//  print(vn3)//崩
  ...
  let vy = dicy.objectForKey("xxx") as! String
  let vy1:String = dicy.objectForKey("xxx") as! String
  let vy2:String? = dicy.objectForKey("xxx") as! String
  let vy3:String! = dicy.objectForKey("xxx") as! String
...
//  print(vn3)//崩
  ...
  if paramaDic == nil {
    ...
    let vp = paramaDic!.objectForKey("xxx") as? String
    //  let vp1:String = (paramaDic.objectForKey("xxx") as? String)!//崩
    let vp2:String? = paramaDic!.objectForKey("xxx") as? String
    let vp3:String! = paramaDic!.objectForKey("xxx") as? String
...
/*
 ...
 注意左边的变量不能加？!，否则会判断异常
 */
private func kl_OptionalBinding(str:String) {
