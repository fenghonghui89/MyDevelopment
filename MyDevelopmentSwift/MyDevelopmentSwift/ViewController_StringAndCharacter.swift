//
//  ViewController_StringAndCharacter.swift
//  MyDevelopmentSwift
//
...
class ViewController_StringAndCharacter: UIViewController {
  ...
  //MARK:字符串中的特殊字符
  func func_StringSpecialCharacter(){
  ...
  func func_AccessAndChangeString(){
