...
class ViewController_Set: UIViewController {
  
  override func viewDidLoad() {
    
    super.viewDidLoad()
    
    func_PerformingSetOperations()
  }
  ...
  func func_PerformingSetOperations (){
